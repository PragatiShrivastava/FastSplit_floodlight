...
import net.floodlightcontroller.mobilityprotocols.MobilityService;
...
public abstract class ForwardingBase implements IOFMessageListener {
	...
	public static int FLOWMOD_DEFAULT_IDLE_TIMEOUT = 0; // in seconds   // i changed from 5 to 0
	...
	protected ILinkDiscoveryService linkdiscoveryservices;
