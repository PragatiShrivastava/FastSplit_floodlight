...
public class BasicOpenflow extends ForwardingBase implements IFloodlightModule {
	protected static Logger log = LoggerFactory.getLogger(BasicOpenflow.class);
...
//			}
    ...
    private class switchlistener implements IOFSwitchListener{
		...
		public void switchAdded(DatapathId switchId) {
			...
			if(nos < 37)   // 280 , 51 , 43 , 37
				nos++;
			if(nos == 36)  //279  , 50 ,42, 36
			{
				System.out.println("nossssss="+ nos);
				SetSwitchMap();
				findadj();
